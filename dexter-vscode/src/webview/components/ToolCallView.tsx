import type { ToolStartEvent, ToolProgressEvent, ToolEndEvent, ToolErrorEvent } from '../types';
...
export function ToolCallView({ tool, startEvent, progressEvents = [], endEvent, errorEvent }: ToolCallViewProps) {
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        {endEvent && (
          <span className="text-xs text-gray-500">
            {(endEvent.duration / 1000).toFixed(2)}s
          </span>
        )}
      </div>
